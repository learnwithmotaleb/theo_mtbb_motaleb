        ...
        <SafeAreaView style={styles.safe}>
            ...
            >
                ...
                <Body3 align="center" color={Colors.TEXT_COLOR} style={styles.subtitle}>
                    {t("Your profile has been successfully created. You will start receiving your first missions.")}
                </Body3>
                ...
                <View style={styles.miniCardsRow}>
                    <View style={styles.miniCard}>
                       <BellIcon size={24}/>
                        ...
                        <Body6 color={Colors.TEXT_COLOR}>{t("Push active")}</Body6>
                    </View>
                    <View style={styles.miniCard}>
                        ...
                        <Body6 color={Colors.TEXT_COLOR}>{t("KYC Level 1")}</Body6>
                    </View>
                </View>
            </ScrollView>
