...
// Mirrors ACCOMMODATION_TYPES on the backend — anything else is rejected.
const PROPERTY_TYPES = ['Apartment', 'House', 'Studio', 'Other'];
...
export default function PropertyScreen() {
    ...
    const handleContinue = () => {
        ...
        dispatch(
            updateDraft({
                accommodationType: type as typeof draft.accommodationType,
                numberOfRooms: String(bedrooms),
                surface: surface.trim(),
                // The accommodation model has no bathroom/toilet counts, so
                // they are kept in the host-facing notes.
                notes: `${bathrooms} bathroom(s) - ${toilets} toilet(s)`,
            }),
        );
           ...
           <SectionTitle/>
            ...
            >
                ...
                <Body6 align="center" color={Colors.TEXT_COLOR} style={styles.subtitle}>
                    {t("This information helps us estimate the time and cost of the cleaning.")}
                </Body6>
                ...
                <Counter label={t("Number of bedrooms")} value={bedrooms} onChange={setBedrooms} />
                <Counter label={t("Number of bathrooms")} value={bathrooms} onChange={setBathrooms} />
                <Counter label={t("Number of toilets")} value={toilets} onChange={setToilets} />
