...
const nextSteps = (t: Translate) => [
    {
        ...
        desc: t("Choose the date, time, and cleaning details."),
    },
    {
        icon: <HousekeeperIcon size={22} color={Colors.STATUS_COLOR} />,
        title: t("Discover my dashboard"),
        desc: t("Manage your properties, your cleanings, and your invoices."),
    },
    {
        icon: <HeadPhoneIcon size={22} color={Colors.STATUS_COLOR} />,
        title: t("Need help?"),
        desc: t("Check our help center or contact our support."),
    },
];
...
export default function AndNextScreen() {
    ...
    // replace, so the back gesture cannot walk back into the wizard.
          ...
          <SectionTitle/>
            ...
            >
                ...
                <Body6 color={Colors.TEXT_COLOR} style={styles.subtitle}>
                    {t("Send your first cleaning request in just a few clicks.")}
                </Body6>
