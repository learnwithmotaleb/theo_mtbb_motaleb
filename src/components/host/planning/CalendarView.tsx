...
type Props = {
    ...
    hasData: boolean;
    /** Bookings + their cleanings for the month being shown. */
...
export function CalendarView({
    ...
    // Paging the grid also tells the parent which month to fetch.
        ...
        <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
            ...
            {!hasData ? (
                <View style={styles.emptyState}>
                    ...
                    >
                        {t("Connect your booking calendar (Airbnb, Booking.com etc.) to automatically display your reservations")}
                    </Caption3>
                    <CustomButton
                        title={t("Connect my calendar")}
                        ...
                        <View style={styles.popup}>
                            ...
                            <View style={styles.popupTimes}>
                                <View style={styles.popupTimeItem}>
                                    <Caption4 color={Colors.TEXT_COLOR}>{t("CHECK-OUT")}</Caption4>
                                ...
                                <View style={styles.popupTimeItem}>
                                    <Caption4 color={Colors.TEXT_COLOR}>{t("CHECK-IN")}</Caption4>
