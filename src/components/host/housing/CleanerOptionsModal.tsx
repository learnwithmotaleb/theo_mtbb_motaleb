                ...
                <Pressable style={styles.overlay} onPress={onClose}>
                    <View style={styles.sheet}>
                        ...
                        <Pressable style={styles.option} onPress={handleRemove}>
                            <Body6 color={Colors.COLOR_DANGER}>{t("Remove")}</Body6>
                        </Pressable>
                        ...
                        {isPrimary ? (
                            <Pressable style={styles.option} onPress={onMakeSubstitute}>
                                <Body6 color={Colors.PRIMARY_TEXT}>{t("Make Substitute")}</Body6>
                            </Pressable>
                        ) : (
                            
                            <Pressable style={styles.option} onPress={onMakePrimary}>
                                <Body6 color={Colors.PRIMARY_TEXT}>{t("Make Primary")}</Body6>
                            </Pressable>
                        )}
                    </View>
                </Pressable>
            ...
            >
                ...
                >
                    <View style={styles.confirmModal}>
                        ...
                        >
                            {t("Do you want to Remove this Cleaner")}
                        </Body6>
                        ...
                        <View style={styles.confirmBtns}>
                            ...
                            >
                                <Caption3 color="#fff">{t("Remove")}</Caption3>
                            </Pressable>
                            <Pressable
                                style={[styles.confirmBtn, styles.cancelBtn]}
                                onPress={() => setConfirmVisible(false)}
                            >
                                <Caption3 color={Colors.PRIMARY_TEXT}>{t("Cancel")}</Caption3>
                            </Pressable>
                        </View>
                    </View>
                </Pressable>
