...
export function AlertScreen({
    ...
    data: TaskStatusScreenData['report_problem'];
        ...
        <View style={styles.container}>
            ...
            >
                ...
                <View style={styles.cleanerRow}>
                    ...
                    <Pressable style={styles.messageBtn}
                        onPress={onContactCleaner ?? (() => router.push('/host/(tabs)/message'))}
                ...
                <View style={styles.photosRow}>
                    {data.photos.map((photo, idx) => (
                        <AppImage key={idx} source={photo} style={styles.photo} contentFit="cover" />
                    ))}
                </View>
                ...
                <View style={styles.detailsCard}>
                    <Caption3 color={Colors.TEXT_COLOR}>{t("Ligament")}</Caption3>
            ...
            <View style={styles.footer}>
                ...
                <Caption3 color={Colors.TEXT_COLOR} align="center" style={{ paddingBottom: hp(0) }}>
                    {t("This alert will be removed from the home screen.")}
                </Caption3>
            </View>
        </View>
    );
