...
export function AcceptedInvitationScreen({
    ...
    data: TaskStatusScreenData['pending_accept'];
}) {
    const t = useT();
        ...
        <>
            ...
            >
                ...
                <Caption3 color={Colors.TEXT_COLOR} align="center" style={styles.desc}>
                    {t("She is joining your household and will be able to receive missions.")}
                </Caption3>
                ...
                <View style={styles.card}>
                    ...
                    <View>
                        ...
                        <Caption3 color={"#35A9D6"}>{t("Verified")}</Caption3>
                        <Caption2 color={Colors.TEXT_COLOR}>{t("Housekeeper")}</Caption2>
                    </View>
                </View>
