...
export function CleanerDenyScreen({
    ...
    data: TaskStatusScreenData['refused'];
    /** Send this accommodation's request to another nearby housekeeper. */
    onInvite?: (cleanerId: string) => void;
}) {
    const t = useT();
        ...
        >
            ...
            <View style={styles.denyBox}>
                ...
                <Caption3 color={Colors.TEXT_COLOR} align="center">
                    {t("No worries, choose another housekeeper for this cleaning.")}
                </Caption3>
            </View>
            ...
            <View style={styles.apartmentCard}>
                ...
                <View style={styles.apartmentInfo}>
                    ...
                    <View style={styles.infoRow}>
                        ...
                        <View>
                            <Caption4 color={Colors.TEXT_COLOR}>{t("Location:")}</Caption4>
                    ...
                    <View style={styles.infoRow}>
                        ...
                        <View>
                            <Caption4 color={Colors.TEXT_COLOR}>{t("Ideal slot:")}</Caption4>
                    ...
                    <View style={styles.infoRow}>
                        ...
                        <View>
                            <Caption4 color={Colors.TEXT_COLOR}>{t("Time slot:")}</Caption4>
            ...
            {data.noHousekeeperAvailable && (
                <View style={styles.noHkBox}>
                    <Body4 color={Colors.TEXT_COLOR}>{t("No other housekeepers available")}</Body4>
                    <Caption3 color={Colors.TEXT_COLOR}>
                        {t("Add a new housekeeper to your property.")}{'\n'}
                        {t("We have professionals available near your accommodation.")}
                    </Caption3>
                </View>
            )}
            ...
            <Body4 color={Colors.TEXT_COLOR} style={styles.sectionTitle}>
                {t("Nearest Housekeeper")}
            </Body4>
            {data.nearestHousekeepers.map((hk) => (
                <View key={hk.id} style={styles.hkRow}>
                    <AppImage source={hk.image} style={styles.hkAvatar} contentFit="cover" />
                    <View style={{ flex: 1 }}>
                    ...
                    <Pressable style={styles.sendBtn} onPress={() => onInvite?.(hk.id)}>
                        <Caption3 color={Colors.TEXT_COLOR}>{t("Send")}</Caption3>
                    </Pressable>
                </View>
            ))}
